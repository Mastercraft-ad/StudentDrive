...
export function PublicFooter() {
  ...
  return (
    <footer className="bg-gradient-to-b from-background to-muted/30 border-t border-border/50 py-12 mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-heading font-bold text-lg bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">StudentDrive</span>
            </div>
            <p className="text-sm text-muted-foreground mb-4">
              Empowering students worldwide with verified study materials, interactive quizzes, and performance analytics.
            </p>
